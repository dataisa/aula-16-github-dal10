...
-- 4º Etapa: Preenchimento das tabelas do DW
-- Preenchendo a Dimensão Tempo 
...
-- Análise Exploratória da Dim Item Grupo 
...
-- Preenchimento da Dim item grupo 
...
-- Prenchimento da Dim item modalidade
...
-- Preenchimento: DIM ITEM ELEMENTO
...
-- Último passo: visualizar a view! 

SELECT * FROM data_warehouse.view_empenho_por_ano